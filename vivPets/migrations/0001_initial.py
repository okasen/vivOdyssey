    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_skills', models.ManyToManyField(to='vivPets.Skill')),
                ('egg', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='vivPets.egg')),
            ],
        ),
        migrations.CreateModel(
            name='Variant',
            fields=[
                ...
                ('extra_skills', models.ManyToManyField(to='vivPets.Skill')),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='vivPets.species')),
            ],
        ),
        migrations.CreateModel(
            name='Pet',
            fields=[
                ...
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='vivPets.species')),
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='vivPets.variant')),
            ],
        ),
    ]
